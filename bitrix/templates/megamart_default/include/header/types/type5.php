...
<header class="<?=$sHeaderClass?>">
	<div class="l-head__main main-main-menu is-active-menu">
	...
	<div class="l-head__main main-menu-compact">
		<div class="<?=$sHeaderBackgroundClass?>" style="padding: 10px 0">
			<div class="l-head__line ">
				<div class="container">
					<div class="l-head__line-inner d-flex" style="align-items: center; justify-content: space-between">
						<div class="l-head__logo-slogan d-flex align-items-center mr-3">
							<div class="d-block l-head__logo">
								<a class="b-header-logo" href="<?=SITE_DIR?>">
									<?$APPLICATION->IncludeFile(
						...
						<div class="l-head__line">
							<div class="container">
								<div class="d-flex align-items-center justify-content-between">
									<div class="d-block flex-grow-0 l-head__vertical-menu order-1 compact-catalog-item">
										<?$APPLICATION->IncludeFile(
											SITE_DIR.'include/header/menu_vertical.php',
											array(),
											array(
									...
									<div class="d-flex flex-grow-1 flex-shrink-1 order-2 l-head__menu compact-other-item">
										<?/*$APPLICATION->IncludeFile(
											SITE_DIR.'include/header/menu_main.php',
											array(),
											array(
										...
										<div class="l-mmenu-type1 l-mmenu-type1--primary is-ready" id="mainMenu_XEVOpk" style="opacity: 1; overflow: visible; max-height: none; visibility: visible;">
											<div class="mmenu-type1-item mmenu-type1-item--primary">
												<a href="/brands/" class="mmenu-type1-item__link headers-links-main-menu brands-top-menu-btn waves-effect waves-effect waves-base">Бренды</a>
											</div>
										</div>
									</div>
						...
						<div class="d-block my-4 mail-block-wrap">
							<?$APPLICATION->IncludeFile(
								SITE_DIR.'/include/footer/emails.php',
								array(),
								array(
						...
						<div class="l-head__search d-flex flex-md-grow-1 flex-lg-grow-0 align-items-center mx-4" style="max-width: 300px">
							<?$APPLICATION->IncludeFile(
								SITE_DIR.'/include/header/search_form.php',
								array(),
								array(
