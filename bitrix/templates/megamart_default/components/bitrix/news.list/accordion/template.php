...
$elementDeleteParams = array('CONFIRM' => Loc::getMessage('RS_MM_NL_TPL_ACCORDION_ELEMENT_DELETE_CONFIRM'));
...
$arParams['MESS_BTN_FILTER_ALL'] = $arParams['MESS_BTN_FILTER_ALL'] ?: Loc::getMessage('RS_MM_NL_TPL_ACCORDION_FILTER_ALL');
?>
<div id="<?=$sBlockId?>">
	<?php
	if (isset($arResult['FILTER']['VALUES']))
	{
		?>
		...
		<div class="nav-wrap">
			<ul class="nav nav-slide" id="<?=$sBlockId?>_filter">
				<?php
				foreach ($arResult['FILTER']['VALUES'] as $arFilter)
				{
					?>
					<li class="nav-item">
