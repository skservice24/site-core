	...
	<div class="row align-items-stretch">
		...
		<div class="col-12 col-md-6 d-flex flex-column justify-content-stretch">
			...
			if (!empty($arResult['SIDEBANNERS']))
			{
				...
				?>
					<div class="rs-banners_banner--side flex-grow-1 position-relative overflow-hidden<?=($key != 0 ? ' mt-6 mt-md-gutter' : ' mt-md-0')?>"  id="<?=$areaIds[$arImage['ID']]?>">
						<?php
						if ($arImage['LINK'])
						{
							?>
		...
		<div class="col-12 col-md-6 d-flex align-items-stretch">
			...
			<div class="rs-banners_banner pb-6 pb-md-0 d-flex mt-6 mt-md-0" id="<?=$areaIds[$item['ID']]?>">
