...
{
	$arParams['LINK_BTN_REQUEST'] = SITE_DIR.'product-ask/?element_id=#ELEMENT_ID#';
}
...
$arParams['PRODUCT_ROWS_USE_COLLAPSE'] = isset($arParams['PRODUCT_ROWS_USE_COLLAPSE']) && $arParams['PRODUCT_ROWS_USE_COLLAPSE'] === 'Y' ? 'Y' : 'N';

$arParams['PRODUCT_ROWS_COLLAPSE_SHOWED'] = isset($arParams['PRODUCT_ROWS_COLLAPSE_SHOWED']) ? (int)$arParams['PRODUCT_ROWS_COLLAPSE_SHOWED'] : 5;


// $arResult['ORIGINAL_PARAMETERS'] = array_merge(
// 	$arResult['ORIGINAL_PARAMETERS'],
// 	[
// 		'SLIDER_RESPONSIVE_SETTINGS' => $arParams['SLIDER_RESPONSIVE_SETTINGS'],
...
// 		'PRODUCT_ROWS_USE_COLLAPSE' => $arParams['PRODUCT_ROWS_USE_COLLAPSE'],
// 		'PRODUCT_ROWS_COLLAPSE_SHOWED' => $arParams['PRODUCT_ROWS_COLLAPSE_SHOWED'],
// 	]
// );
