...
<script id="basket-item-template" type="text/html">
	<tr class="basket-items-list-item-container{{#SHOW_RESTORE}} basket-items-list-item-container-expend{{/SHOW_RESTORE}}{{#SHOW_LOADING}} is-loading{{/SHOW_LOADING}}"
		...
		{{^SHOW_RESTORE}}
			<td class="basket-items-list-item-descriptions">
				<div class="basket-items-list-item-descriptions-inner" id="basket-item-height-aligner-{{ID}}">
					...
					<div class="basket-item-block-info">
						...
						{
							?>
							<span class="basket-item-actions-block d-block d-sm-none">
								<span class="basket-item-actions-container">
									<span class="basket-item-actions-label">
														...
														<div class="basket-item-property-value">
															...
															<?php else: ?>
																<div class="dropdown position-static">
																	<a class="btn btn-outline-secondary dropdown-toggle" href="#" role="button" data-toggle="dropdown" data-flip="false" aria-haspopup="true" aria-expanded="false" data-boundary="window">
																		{{SELECT_VALUE}}
																	</a>

																	<div class="dropdown-menu">
																		{{#SKU_VALUES_LIST}}
																			<a class="dropdown-item{{#NOT_AVAILABLE_OFFER}} disabled{{/NOT_AVAILABLE_OFFER}}{{#SELECTED}} selected{{/SELECTED}}" title="{{NAME}}"
																				data-entity="basket-item-sku-field"
																				data-initial="{{#SELECTED}}true{{/SELECTED}}{{^SELECTED}}false{{/SELECTED}}"
																				data-value-id="{{VALUE_ID}}"
																				data-sku-name="{{NAME}}"
			...
			{
				?>
				<td class="basket-items-list-item-remove d-none d-sm-table-cell">
