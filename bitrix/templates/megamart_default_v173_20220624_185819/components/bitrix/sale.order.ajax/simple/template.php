...
if (isset($arResult['ALLOW_ORDER']) && !$arResult['ALLOW_ORDER'])
{
	global $USER;
...
else
{
	...
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
		...
		<div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?>">
			<!--	MAIN BLOCK	-->
			<div class="col-lg-9 bx-soa">
				...
				<!--	REGION BLOCK	-->
				<div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active bx-selected">
					<div class="bx-soa-section-title-container">
						<div class="row align-items-center">
							<h2 class="bx-soa-section-title col-sm-9">
				...
				<div class="soa-section-columns">
					<? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
						<!--	PAY SYSTEMS BLOCK	-->
						<div id="bx-soa-paysystem" data-visited="false" class="bx-soa-section bx-active bx-selected">
							<div class="bx-soa-section-title-container">
								<div class="row align-items-center">
									<h2 class="bx-soa-section-title col-sm-9">
										<span class="bx-soa-section-title-icon">
						...
						<!--	DELIVERY BLOCK	-->
						<div id="bx-soa-delivery" data-visited="false" class="bx-soa-section bx-active bx-selected" <?=($hideDelivery ? 'style="display:none"' : '')?>>
							<div class="bx-soa-section-title-container">
								<div class="row align-items-center">
									<h2 class="bx-soa-section-title col-sm-9">
										<span class="bx-soa-section-title-icon">
				...
				<!--	PICKUP BLOCK	-->
				<div id="bx-soa-pickup" data-visited="false" class="bx-soa-section bx-selected" style="display:none">
					<div class="bx-soa-section-title-container">
						<div class="row align-items-center">
							<h2 class="bx-soa-section-title col-sm-9">
				...
				<!--	BUYER PROPS BLOCK	-->
				<div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active bx-selected">
					<div class="bx-soa-section-title-container">
						<div class="row align-items-center">
							<h2 class="bx-soa-section-title col-sm-9">
								<span class="bx-soa-section-title-icon">
				...
				<? if ($arParams['BASKET_POSITION'] === 'after'): ?>
					<!--	BASKET ITEMS BLOCK	-->
					<div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active bx-selected">
						<div class="bx-soa-section-title-container">
							<div class="row align-items-center">
								<h2 class="bx-soa-section-title col-sm-9">
									<span class="bx-soa-section-title-icon">
				...
				<div id="bx-soa-orderSave" class="bx-soa-order-save">
					...
					<a href="javascript:void(0)" class="mt-6 btn btn-primary d-none d-sm-block" data-save-button="true">
						<?=$arParams['MESS_ORDER']?>
					</a>
				</div>
