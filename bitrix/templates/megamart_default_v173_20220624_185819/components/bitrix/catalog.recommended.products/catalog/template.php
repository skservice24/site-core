...
if (!empty($arResult['RECOMMENDED_IDS']))
{
	...
	$productRowVariants = '';
	if (!empty($arParams['PRODUCT_ROW_VARIANTS']))
	{
		$productRowVariants = $arParams['PRODUCT_ROW_VARIANTS'];
	}
	else
	{
		if ($bMegamartInclude)
	...
	$arParams['~MESS_RELATIVE_QUANTITY_MANY'] = $arParams['~MESS_RELATIVE_QUANTITY_MANY'] ?: Loc::getMessage('CATALOG_RECOMMENDED_PRODUCTS_RELATIVE_QUANTITY_MANY');
	$arParams['~MESS_RELATIVE_QUANTITY_FEW'] = $arParams['~MESS_RELATIVE_QUANTITY_FEW'] ?: Loc::getMessage('CATALOG_RECOMMENDED_PRODUCTS_RELATIVE_QUANTITY_FEW');
